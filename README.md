...
This is a project is the process to understant how to create my own API for a simple voting system. In this website. I am only putting only one option of voting for a specific cat. 

![img1]https://github.com/themiscadiz/Assignment4/blob/master/Images/16.png?raw=true
